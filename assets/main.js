...
function resolveAssetUrl(filename) {
  if (typeof window !== 'undefined' && window.ShopifyTheme && window.ShopifyTheme.assetUrl) {
...
let cartState = [
  { id: 'luxe-handbag', name: 'Luxe Structured Handbag', price: 129.00, quantity: 1, image: resolveAssetUrl('luxe-handbag.jpg') },
  { id: 'scented-candle', name: 'Bohemian Amber Scented Candle', price: 26.00, quantity: 1, image: resolveAssetUrl('candle.jpg') }
];
